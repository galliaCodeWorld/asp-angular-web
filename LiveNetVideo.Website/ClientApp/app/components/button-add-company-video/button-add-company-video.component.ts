...
@Component({
	selector: 'button-add-company-video',
	templateUrl: 'button-add-company-video.component.html'
})
export class ButtonAddCompanyVideoComponent {
	constructor(
	...
	// TODO: needs to be implemented for video recording
